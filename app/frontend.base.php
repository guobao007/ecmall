...
class FrontendApp extends ECBaseApp
{
    ...
    function display($tpl)
    {
        ...
        $this->assign('header_gcategories',$gcategory_mod->_get_header_gcategories(0,1));
...
//        $this->_view->res_base     = SITE_URL . "/themes/store/{$template_name}/styles/{$style_name}";
        $this->_view->res_base     = SITE_URL . "/themes/store/{$template_name}/styles/default";
        
        $mallStyle = SITE_URL . "/themes/mall/default/styles/default";
        $this->assign('mallStyle',$mallStyle);
    }
    ...
    function get_store_data()
    {
        ...
        if ($store === false)
        {
            ...
            //热门推荐
            $store['rec_goodslist'] = $this->_get_rec_goods($this->_store_id);
    ...
    function _get_rec_goods($id, $num = 5) {

...
//        ));
    ...
    public function ajax_load(){
        ...
        foreach ($carts as $k=>$v){
            $cart_all_price += $v['amount'];
            $cart_goods_num += $v['kinds'];
            foreach ($v['goods'] as $k2=>$v2){
                $cartList[] = array(
                    ...
                    'goods_num' => $v2['quantity'],
                    'goods_image' => $v2['goods_image'],
                    'goods_url' => 'index.php?app=goods&id='.$v2['goods_id'],
                );
            }
        }
        
        $json_data = json_encode(array('list'=>$cartList,'cart_all_price'=>$cart_all_price,'cart_goods_num'=>$cart_goods_num));
    ...
    public function del(){
        ...
        exit(json_encode(array('state'=>1,'quantity'=>intval($quantity),'amount'=>intval($amount))));
    }

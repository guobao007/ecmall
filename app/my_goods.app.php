...
class My_goodsApp extends StoreadminbaseApp
{
    ...
    function add()
    {
        ...
        else
        {
            ...
            $dirname = 'data/files/store_' . $this->visitor->get('manage_store') . '/qrcode/';
            $PhpQRCode->set('pngTempDir',$dirname);
            $PhpQRCode->set('date',SITE_URL. '/index.php?app=goods&id='.$goods_info['goods_id']);
            $PhpQRCode->set('pngTempName', $goods_info['goods_id'] . '.png');
            $PhpQRCode->init();
    ...
    function edit()
    {
        ...
        else
        {
            ...
            $dirname = 'data/files/store_' . $this->visitor->get('manage_store') . '/qrcode/';
            $PhpQRCode->set('pngTempDir',$dirname);
            $PhpQRCode->set('date',SITE_URL. '/index.php?app=goods&id='.$id);
            $PhpQRCode->set('pngTempName', $id . '.png');
            $PhpQRCode->init();
            $this->show_message('edit_ok',
                'back_list', 'index.php?app=my_goods',

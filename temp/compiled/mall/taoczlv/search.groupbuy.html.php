			...
			<div class="search-by mb10">
				<ul>
					<li class="state clearfix">
						<h3>group_state</h3>
                        <a href="javascript:;" ectype="state" <?php if ($_GET['state'] == ''): ?>class="act"<?php endif; ?> id="">no_limit</a>
					...
					<li class="admin_recomand clearfix" style="border:0px;">
                        ...
                        <a href="javascript:;" ectype="recommend" <?php if ($_GET['recommend'] == ''): ?>class="act"<?php endif; ?> id="">no_limit</a>
...
?>
                 	<li class="item mb20" <?php if ($this->_foreach['fe_group']['iteration'] % 4 == 0): ?> style="margin-right:0"<?php endif; ?>>
                    	...
                    	<div class="extra">
                   			<span><strong><?php echo $this->_var['group']['discount']; ?></strong>zhe</span><span>剩余时间：<?php echo $this->_var['group']['lefttime']; ?></span><span><b><?php echo $this->_var['group']['quantity']; ?></b>man_join</span>

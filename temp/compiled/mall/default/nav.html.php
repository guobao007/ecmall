...
?>
        ...
        <ul class="site-menu">
            <li><a class="<?php if ($this->_var['index']): ?>current<?php endif; ?>" href="index.php"><span>首页</span></a></li>
...
?>
            <li><a class="<?php if (! $this->_var['index'] && $this->_var['nav']['link'] == $this->_var['current_url']): ?>current<?php endif; ?>" href="<?php echo $this->_var['nav']['link']; ?>"<?php if ($this->_var['nav']['open_new']): ?> target="_blank"<?php endif; ?>><?php echo htmlspecialchars($this->_var['nav']['title']); ?></a></li>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
            <li><a class="<?php if ($this->_var['zslm']): ?>current<?php endif; ?>" href="<?php echo url('app=zslm'); ?>"><span>招商入驻</span></a></li>
        </ul>
    </div>

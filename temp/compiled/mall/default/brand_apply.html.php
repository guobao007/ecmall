...
<ul class="tab">
    <li class="active"><?php if ($_GET['act'] == brand_edit): ?>编辑品牌<?php else: ?>新增品牌申请<?php endif; ?></li>
</ul>
<div class="eject_con">
    <div class="adds">
        <div id="warning"></div>
        ...
        <ul>
            ...
            <li>
                ...
                <div class="sign_box">
                    <div class="sign_con">
                        <div class="sign"><img src="<?php if ($this->_var['brand']['brand_logo']): ?><?php echo $this->_var['brand']['brand_logo']; ?><?php else: ?>data/system/no_pic.gif<?php endif; ?>" width="150" height="50" alt="" ectype="logo1"/></div>

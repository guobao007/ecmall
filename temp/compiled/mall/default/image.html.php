...
<input onchange="$('#submit_button').click();" type="file" name="file" style="width: 120px; height: 28px; cursor: hand; cursor: pointer;  opacity:0; filter: alpha(opacity=0)" size="1" hidefocus="true" maxlength="0">
</span>
